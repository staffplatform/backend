...
export class AuthService {
  private static readonly DEFAULT_ACCESS_EXPIRES_IN: NonNullable<JwtSignOptions['expiresIn']> =
    '15m';
  private static readonly DEFAULT_REFRESH_EXPIRES_IN: NonNullable<JwtSignOptions['expiresIn']> =
    '7d';

  private readonly accessTokenSecret: string;
  private readonly refreshTokenSecret: string;
  private readonly accessTokenExpiresIn: NonNullable<JwtSignOptions['expiresIn']>;
  private readonly refreshTokenExpiresIn: NonNullable<JwtSignOptions['expiresIn']>;
